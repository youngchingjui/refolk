...
**Status:** Early stage / pre-launch. Pricing is intentionally simple to get live quickly and gather real customer feedback.
...
Once we have 10-20 paying customers, we'll have real data to inform pricing decisions.

## What's Included (Revised - Persona Access Model)
...
- Pick from our roster (or we recommend based on your industry)
...
- Request custom persona development
- Priority support
- API access
...
- Everything in Team
- Unlimited seats
- Custom persona development (we build them for you)
...
- **Persona selection:** Starter gets 3 - do they pick any 3, or from a recommended subset?
- **Custom persona creation:** Team tier only (keep Starter simple)? Or offer as add-on?
- **Seat pricing:** Keep it simple with fixed 5 seats on Team, or charge per additional seat?
- **Annual discounts:** Offer 2 months free for annual commitment? (Helps cash flow and retention)
- **Free tier vs trial:** 7-day free trial with full access? Or freemium with 1 persona forever?
- **Persona switching:** Can Starter users change which 3 personas they have access to? (Recommend yes, maybe monthly)
...
1. Launch with $50 Starter / $300 Team
2. Get 10-20 paying customers
3. Conduct pricing interviews to understand perceived value
4. Analyze usage patterns (which features matter most?)
